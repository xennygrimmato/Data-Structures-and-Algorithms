...
Array2D::Array2D(std::vector<std::vector<double>> arr)
{
    _core = arr;
}
...
double Array2D::Index(int I, int J)
{
    return _core[I][J];
}

void Array2D::SetIndex(int I, int J, double value)
{
    _core[I][J] = value;
}

void Array2D::AddColumn(std::vector<double> column)
{
...
double Array2D::Det()
{
    ...
    case 1:
        return _core[0][0];
    case 2:
        return _core[0][0] * _core[1][1] - _core[1][0] * _core[0][1];
    default:
    {
